  ...
  const menuByCategory = [
    {
      ...
      items: [
        [
          'French Fries',
          'Crispy golden fries with house seasoning',
          129,
          'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Crispy Corn',
          'Sweet corn tossed with chilli, garlic and herbs',
          149,
          'https://images.unsplash.com/photo-1551754655-cd27e38d2076?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Paneer Tikka',
          'Smoky paneer cubes marinated with Indian spices',
          229,
          'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Chicken Wings',
          'Juicy wings glazed with spicy barbecue sauce',
          269,
          'https://images.unsplash.com/photo-1527477396000-e27163b481c2?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Veg Spring Roll',
          'Crunchy rolls packed with seasoned vegetables',
          159,
    ...
    },
    {
      ...
      items: [
        [
          'Pasta Alfredo',
          'Creamy white sauce pasta with parmesan and herbs',
          279,
          'https://images.unsplash.com/photo-1645112411341-6c4fd023714a?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Veg Biryani Bowl',
          'Aromatic rice layered with vegetables and raita',
          249,
          'https://images.unsplash.com/photo-1633945274405-b6c8069047b0?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Paneer Butter Masala',
          'Paneer simmered in rich tomato cashew gravy',
          299,
          'https://images.unsplash.com/photo-1631452180775-44f758469c16?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Chicken Curry Rice',
          'Homestyle chicken curry served with steamed rice',
          329,
          'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Dal Tadka Combo',
          'Yellow dal, jeera rice, salad and papad',
          219,
    ...
    },
    {
      ...
      items: [
        [
          'Veg Burger',
          'Crispy veg patty with lettuce and burger sauce',
          179,
          'https://images.unsplash.com/photo-1571091718767-18b5b1457add?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Chicken Burger',
          'Grilled chicken patty, cheese and smoky mayo',
          229,
          'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Paneer Burger',
          'Grilled paneer steak with mint mayo',
          199,
          'https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Cheese Burger',
          'Classic cheese burger with caramelized onions',
          219,
          'https://images.unsplash.com/photo-1551782450-a2132b4ba21d?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Double Patty Burger',
          'Double patty burger with cheese and pickles',
          289,
    ...
    },
    {
      ...
      items: [
        ...
        [
          'Mojito',
          'Mint, lime and soda served over crushed ice',
          139,
    ...
    },
    {
      ...
      items: [
        [
          'Brownie',
          'Warm chocolate brownie with fudge drizzle',
          159,
          'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Gulab Jamun',
          'Soft milk dumplings soaked in saffron syrup',
          119,
          'https://images.unsplash.com/photo-1666190092159-3171cf0fbb12?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Cheesecake',
          'Creamy baked cheesecake with berry compote',
          219,
          'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Chocolate Sundae',
          'Chocolate ice cream, brownie crumbs and sauce',
          189,
          'https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&w=800&q=80',
        ],
        [
          'Fruit Custard',
          'Seasonal fruits folded in vanilla custard',
          139,
